"""Task 5a -- REFERENCE SOLUTION: the process, with the two recognizers injected.
...
def build_graph(implementations: dict[str, Callable] | None = None):
    ...
    # Task 5a: the two recognizers come from the dictionary -- the process never
    # imports an implementation of them.
